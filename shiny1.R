...
ui <- navbarPage(
  ...
  navbarMenu(
    ...
    tabPanel("Chicago", 
             div("This graph show that the number of word per tweet"),
             div("Compared with distribution of other two cities, this graph is a little bit more right-skewed"),
  ...
  navbarMenu(
    ...
    tabPanel("Los Angeles",
             ...
             div("We found that the most frequently words are electors, doubts, etc. in these tweets"),
             splitLayout(img(src="wordcloudLA.png",height="397",width="428"))),
    tabPanel("Chicago",
             div("this is a separated wordcloud for tweets mentioned Trump around Chicago"),
             div("We found that the most frequently words are intelligence,devastating, etc that are different  with other two cities"),
             splitLayout(img(src="wordcloudC.png",height="349",width="438"))),
    tabPanel("Boston",
             div("Although some words with high frequency for tweets mentioned Trump around Boston are similar to some of the words in tweets mentioned Trumo around Los Angeles, there are also some unique words with relatively high frequency included in the below wordcloud, such as illegitimacy and dark."),
             div("The result might suggest that attitudes of some users in Boston toward Trump are not such good"),
